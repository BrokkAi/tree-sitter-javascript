...
module.exports = grammar({
  ...
  rules: {
    ...
    _jsx_identifier: $ => choice(
      ...
      $.identifier,
      alias($._reserved_word, $.identifier),
    ),

    // JavaScript's word token lexes reserved words as keywords whenever a
    // state admits them. JSX names accept those words as identifier-like
    // element names, attribute names, and namespace segments.
